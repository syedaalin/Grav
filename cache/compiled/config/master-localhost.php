...
return [
    ...
    'files' => [
        'user/localhost/config' => [
            ...
            'themes/nur-e-hidayat' => [
                'file' => 'user/localhost/config/themes/nur-e-hidayat.yaml',
                'modified' => 1767942918
            ],
            'themes/nur-ul-huda' => [
        ...
        'user/config' => [
            ...
            'themes/akazie-forest' => [
                'file' => 'user/config/themes/akazie-forest.yaml',
                'modified' => 1764384828
            ],
            'themes/cardstack' => [
    ...
    'data' => [
        'themes' => [
            'nur-ul-huda' => [
                ...
                'color_error' => 'oklch(0.55 0.22 25)',
                'color_success' => 'oklch(0.6 0.15 145)',
                'color_surface' => 'oklch(0.98 0.01 260)',
                'color_surface_subtle' => 'oklch(0.95 0.01 260)',
                'color_dark' => 'oklch(0.15 0.02 260)',
                'color_text' => 'oklch(0.2 0.02 260)',
                'color_text_muted' => 'oklch(0.5 0.02 260)',
                'color_subtle' => 'oklch(0.4 0.02 260)',
                'color_border' => 'oklch(0.85 0.01 260)',
                'color_border_subtle' => 'oklch(0.9 0.01 260)',
                'glass_thickness' => 1,
                'glass_shadow_intensity' => 0.1,
                'font_family_base' => 'font-sans',
                'font_size_base' => 16,
                ...
                'bottom_banner_widgets_order' => 'brand,social,nav,newsletter,copyright',
                'top_banner_quotes' => [
                    0 => [
                        'text' => NULL,
                        'source' => NULL
            ...
            'akazie-forest' => [
                ...
                'site' => [
                    'maxwidth' => '1280',
                    'sectionwrappadding' => '20px 20px',
                    'sectionwrappaddingmobile' => '20px 20px',
                    'favicon' => [
                        'user/themes/akazie-forest/custom/images/favicon/favicon.png' => [
                            'name' => 'favicon.png',
                            'full_path' => 'favicon.png',
                            'type' => 'image/png',
                            'size' => 321661,
                            'path' => 'user/themes/akazie-forest/custom/images/favicon/favicon.png'
                        ]
                    ]
                ],
                'header' => [
                    ...
                    'closemenucaption' => 'schliessen',
                    'logo' => [
                        'desktop' => [
                            'user/themes/akazie-forest/custom/images/logo/logo.png' => [
                                'name' => 'logo.png',
                                'full_path' => 'logo.png',
                                'type' => 'image/png',
                                'size' => 321661,
                                'path' => 'user/themes/akazie-forest/custom/images/logo/logo.png'
                            ]
                        ],
                        'mobile' => [
                            'user/themes/akazie-forest/custom/images/logo/logo.png' => [
                ...
                'nav' => [
                    ...
                    'navheight' => '85',
                    'hamburger' => true,
                    'linksbeforehamburger' => 3,
                    'mobileheightenabled' => '1',
                    'mobilelogoenabled' => '1',
                    'customcode' => NULL,
                    'mobilenavheight' => '85',
                    'hamburgercolor' => '#7b9b50',
                    'xcolor' => '#7b9b50',
                    'button' => [
                        'enabled' => false,
                        'text' => NULL,
                ...
                'footer' => [
                    ...
                    'copyright' => [
                        'enabled' => true,
                        'text' => 'Copyright © Aabtaab 2025. All rights reserved'
                    ],
                    'impressum' => [
                        'enabled' => true,
                        'link' => '/home'
            ...
            'my-nur-ul-huda' => [
                'streams' => [
                    'schemes' => [
                        'theme' => [
                            ...
                            'prefixes' => [
                                '' => [
                                    0 => 'user/themes/my-nur-ul-huda',
                                    1 => 'user/themes/nur-ul-huda'
                                ]
                            ]
                        ]
                    ]
                ...
                'social_links' => [
                    ...
                    2 => [
                        'network' => 'youtube',
                        'url' => 'https://www.youtube.com/@AabTaab'
                    ],
                    3 => [
                        'network' => 'instagram',
                        'url' => 'https://www.instagram.com/aabtaab_online/'
                    ],
                    4 => [
                        'network' => 'googlemaps',
                        'url' => 'https://maps.app.goo.gl/YUf2yjfbLy1G6uW19'
                    ]
                ],
                'social_text' => '0',
                'font_primary' => 'Roboto',
            ...
            'my-quark' => [
                ...
                'custom_favicon' => [
                    'user/themes/my-quark/images/favicon/aabtaab-logo.webp' => [
                        'name' => 'aabtaab-logo.webp',
                        'full_path' => 'aabtaab-logo.webp',
                        'type' => 'image/webp',
                        'size' => 56746,
                        'path' => 'user/themes/my-quark/images/favicon/aabtaab-logo.webp'
                    ]
                ],
                'fluid_type' => '1',
                'font_size_min' => 16,
                ...
                'navigation_structure' => [
                    0 => [
                        ...
                        'type' => 'link',
                        'url' => NULL,
                        'collection_source' => '@root.descendants',
                        'collection_type' => 'all',
                ...
                'solid_color' => '#ffffff',
                'token_color_primary' => '#00ff35',
                'token_color_secondary' => '#88c0d0',
                'token_color_accent' => '#bf616a',
                'token_color_bg_body' => '#eceff4',
                'token_color_bg_card' => '#ffffff',
                'token_color_text_main' => '#2e3440',
                'token_color_text_muted' => '#4c566a',
                'token_font_body' => 'Outfit',
                'token_font_header' => 'Outfit',
                'token_typo_fluid' => '1',
                'token_typo_min_size' => 16,
                'token_typo_max_size' => 18,
                'token_typo_scale' => 1.25,
                'token_typo_lh_body' => 1.6,
                'token_typo_lh_heading' => 1.2,
                'token_typo_ls_heading' => -0.02,
                'token_typo_measure' => 65,
                'token_layout_width' => 1200,
                'token_layout_spacing' => 1,
                'physic_glass_opacity' => 8.85,
                'physic_vignette_enabled' => '1',
                'physic_eco_mode' => '0',
                'physic_focus_mode' => '0',
                'agent_header_fixed' => '1',
                'agent_header_animated' => '1',
                'agent_header_dark' => '1',
                'agent_header_transparent' => '1',
                'agent_nav_nodes' => [
                    0 => [
                        'title' => NULL,
                        'type' => 'link',
                ...
                'agent_footer_color_bg' => '#0f0f10',
                'agent_footer_color_text' => '#ffffff',
                'agent_footer_color_accent' => '#d4af37',
                'agent_footer_sticky' => '1',
                'agent_footer_legal_copy' => '&copy; 2026 Semantic OS. All rights reserved.',
                'agent_footer_legal_credits' => 'Architected by Antigravity',
                'agent_env_mode' => 0,
                'agent_env_solid_col' => '#ffffff',
                'agent_env_grad_type' => 'linear',
                'agent_env_grad_angle' => 70,
                'agent_env_grad_start' => '#dd1d7a',
                'agent_env_grad_end' => '#88c0d0',
                'agent_env_img_pos' => 'center center',
                'agent_env_img_size' => 'cover',
                'agent_env_img_attach' => 'fixed',
                'agent_env_img_overlay' => '#000000',
                'agent_env_img_op' => 0.3,
                'agent_env_mesh_1' => '#3b4252',
                'agent_env_mesh_2' => '#bf616a',
                'agent_env_mesh_3' => '#88c0d0',
                'agent_env_mesh_speed' => 20,
                'agent_env_tex' => 'none',
                'agent_env_tex_col' => '#000000',
                'agent_env_tex_op' => 0.05,
                'agent_identity_brandName' => 'Aabtaab',
                'agent_identity_showText' => '1',
                'agent_identity_address' => 'R-591 , Near Amroha Ground , F.B. Area Block 20 (incholi)',
                'agent_identity_email' => 'edu.aabtaab@gmail.com',
                'agent_identity_phone' => '+92 302 245 2000',
                'agent_gov_production' => '1',
                'agent_gov_gridSize' => 'grid-xl',
                'agent_env_img' => [
