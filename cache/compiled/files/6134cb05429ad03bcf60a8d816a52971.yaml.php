...
return [
    ...
    'filename' => '/Users/syedaalin/Documents/Grav/user/plugins/admin/languages/en.yaml',
    'modified' => 1766978626,
    'size' => 70662,
    'data' => [
        'PLUGIN_ADMIN' => [
            ...
            'SAFE_UPGRADE_HELP' => 'Enable guarded staging and rollback pipeline for Grav self-updates',
            'SAFE_UPGRADE_SNAPSHOT_LIMIT' => 'Snapshot Limit',
            'SAFE_UPGRADE_SNAPSHOT_LIMIT_HELP' => 'Maximum number of safe-upgrade snapshots to retain (0 = unlimited)',
            'RECOVERY_MODE' => 'Recovery Mode',
            'RECOVERY_MODE_HELP' => 'Enable recovery mode when fatal errors occur during upgrades. When triggered, displays a recovery screen to help diagnose and resolve issues.',
...
You have **2FA** enabled on this account. Please use your **2FA** app to enter the current **6-digit code** to complete the login process.',
            ...
            'BACKUPS_PROFILE_ENVIRONMENT' => 'Scheduler Environment',
            'BACKUPS_PROFILE_ENVIRONMENT_HELP' => 'Which environment configuration to use when running scheduled backups. If your backup exclusions are saved in a specific environment (e.g., localhost), select that environment here.',
            'COMMAND' => 'Command',
