...
class __TwigTemplate_eb8208adc48d959cb079ce93f6490bdb extends Template
{
    ...
    public function block_field(array $context, array $blocks = []): iterable
    {
        ...
        // line 4
        yield "    ";
        yield from $this->load("forms/fields/column/column.html.twig", 4, 800323373)->unwrap()->yield(CoreExtension::merge($context, ["name" => ($context["name"] ?? null), "fields" => CoreExtension::getAttribute($this->env, $this->source, ($context["field"] ?? null), "fields", [], "any", false, false, false, 4)]));
        yield from [];
    }
...
/* forms/fields/column/column.html.twig */
class __TwigTemplate_eb8208adc48d959cb079ce93f6490bdb___800323373 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
