...
class __TwigTemplate_2f68e5929e0bc0487a071a7d063ddc0f extends Template
{
        ...
        yield "</a>
            ...
            <div class=\"install-package-container hidden\">
                <p>
                    ";
        // line 40
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Grav\Common\Twig\Extension\GravExtension']->translate($this->env, "PLUGIN_ADMIN.READY_TO_INSTALL_PACKAGES"), "html", null, true);
        yield "
                </p>
        ...
        yield "</a>
            ...
            <div class=\"install-package-error hidden\">
                <p>
                    ";
        // line 53
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Grav\Common\Twig\Extension\GravExtension']->translate($this->env, "PLUGIN_ADMIN.ERROR_INSTALLING_PACKAGES"), "html", null, true);
        yield "
                </p>
        ...
        yield "
            ...
            <div class=\"installing-package hidden\">
                <p>
                    ";
        // line 72
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Grav\Common\Twig\Extension\GravExtension']->translate($this->env, "PLUGIN_ADMIN.INSTALLING_PACKAGES"), "html", null, true);
        yield "
                    <span class=\"fa fa-spin fa-spinner\"></span>
                </p>
            ...
            <div class=\"installation-complete hidden\">
                <p>
                    ";
        // line 81
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Grav\Common\Twig\Extension\GravExtension']->translate($this->env, "PLUGIN_ADMIN.PACKAGES_SUCCESSFULLY_INSTALLED"), "html", null, true);
        yield "
                </p>
...
";
    ...
    {
        return new Source("", "partials/modal-add-package.html.twig", "/Users/syedaalin/Documents/Grav/user/plugins/admin/themes/grav/templates/partials/modal-add-package.html.twig");
    }
}
